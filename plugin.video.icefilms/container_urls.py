...
def get():
          ...
          #basic container        
          containers['mv_covers_url'] = 'http://user.gosub.dk/eldorado/'
          containers['mv_covers_filename'] = 'movie_covers.zip'
          containers['mv_cover_size'] = 53
          
          containers['mv_backdrop_url'] = 'http://user.gosub.dk/eldorado/'
          ...
          #basic container       
          containers['tv_covers_url'] = 'http://user.gosub.dk/eldorado/'
          containers['tv_covers_filename'] = 'tv_covers.zip'
          containers['tv_cover_size'] = 131

          containers['tv_banners_url'] = 'http://user.gosub.dk/eldorado/'
          containers['tv_banners_filename'] = 'tv_banners.zip'
          containers['tv_banners_size'] = 45


          containers['tv_backdrop_url'] = 'http://user.gosub.dk/eldorado/'
